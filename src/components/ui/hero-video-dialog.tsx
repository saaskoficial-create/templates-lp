...
export function HeroVideoDialog({
  ...
  if (inline) {
    return (
      <div className={cn("relative overflow-hidden rounded-[26px] border border-white/10 bg-black/20 shadow-lg", className)}>
  ...
  return (
    <div className={cn("relative", className)}>
      <button
        ...
        aria-label="Abrir video da hero"
      >
        ...
        <img
          ...
          width={1920}
          height={1080}
          className="w-full rounded-[26px] border border-white/10 shadow-lg transition-all duration-200 ease-out group-hover:brightness-[0.8]"
        />
        <div className="absolute inset-0 flex items-center justify-center rounded-[26px] transition-all duration-200 ease-out group-hover:scale-100">
